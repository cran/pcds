...
of nontarget points, then points in each triangle will also be uniform (restricted to the triangle,
...
The `plot` of the object returns the scatterplot of the $\X$ points together with Delaunay triangles of $\Y$ points.
...
The `plot` of the object s the scatterplot of the $\X$ points together with Delaunay triangles of $\Y$ points.
```{r segmT, fig.cap="Scatterplot of the $X$ points segregated (in a type I fashion) from the $Y$ points in each Delaunay triangle."}
...
The `plot` of the object s the scatterplot of the $\X$ points together with $\Y$ points 
...
```{r ascmT, fig.cap="Scatterplot of the $X$ points associated (in a type I fashion) with the $Y$ points in each Delaunay triangle."}
...
```{r ascmTcirc, eval=F, fig.cap="Scatterplot of the $X$ points associated (in a circular fashion) with the $Y$ points in each Delaunay triangle."}
